...
|-----------|----------|----------|
| React components, UI, frontend, CSS, client-side state | McManus | Task list component, task form, status toggles |
| Node.js, API routes, database, server-side, backend | Fenster | CRUD endpoints, DB schema, middleware, validation |
| Architecture, design, trade-offs, cross-cutting concerns | Keaton | API contracts, tech stack decisions, code review |
| Code review | Keaton | Review PRs, check quality, architectural sign-off |
| Testing, QA, edge cases, test suites | Hockney | Unit tests, integration tests, API testing, regression |
